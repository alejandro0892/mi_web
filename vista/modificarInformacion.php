...
.fancybox-custom .fancybox-skin {
    ...
    <form action="" method="post">
      <div style="text-align:center; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#FFF;">
        <h1 align="center">Estatus General</h1>
        ...
        <button type="submit" name="botonListar" value="Listar Todos" id="botonListar">Listar Todos </button>
		 <button type="submit" name="botonreporte" value="" id="botonreporte"><a href="reporte_usuarios_pdf.php" target="_blank">Generar Reporte</a></button>
